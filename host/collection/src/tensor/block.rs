    ...
    ($self:ident, $other:ident, $this:ident, $that:ident, $call:expr) => {
        match ($self, $other) {
            (Self::F32($this), Self::F32($that)) => {
                $call.map(ArrayAccess::from).map_err(TCError::from)
            }
...
impl Block {
    pub fn cast<T: CType>(self) -> TCResult<ArrayAccess<T>> {
        block_dispatch!(
            self,
            this,
            this.cast().map(ArrayAccess::from).map_err(TCError::from)
        )
    }

    pub fn and(self, other: Self) -> TCResult<ArrayAccess<u8>> {
        block_cmp!(self, other, this, that, this.and(that))
    }

    pub fn and_scalar(self, other: Number) -> TCResult<ArrayAccess<u8>> {
        block_dispatch!(
            self,
            this,
    ...
    pub fn not(self) -> TCResult<ArrayAccess<u8>> {
        block_dispatch!(
            self,
            this,
            this.not().map(ArrayAccess::from).map_err(TCError::from)
        )
    }

    pub fn or(self, other: Self) -> TCResult<ArrayAccess<u8>> {
        block_cmp!(self, other, this, that, this.or(that))
    }

    pub fn or_scalar(self, other: Number) -> TCResult<ArrayAccess<u8>> {
        block_dispatch!(
            self,
            this,
    ...
    pub fn xor(self, other: Self) -> TCResult<ArrayAccess<u8>> {
        block_cmp!(self, other, this, that, this.xor(that))
    }

    pub fn xor_scalar(self, other: Number) -> TCResult<ArrayAccess<u8>> {
        block_dispatch!(
            self,
            this,
    ...
    pub fn eq(self, other: Self) -> TCResult<ArrayAccess<u8>> {
        block_cmp!(self, other, this, that, this.eq(that))
    }

    pub fn eq_scalar(self, other: Number) -> TCResult<ArrayAccess<u8>> {
        block_dispatch!(
            self,
            this,
    ...
    pub fn gt(self, other: Self) -> TCResult<ArrayAccess<u8>> {
        block_cmp!(self, other, this, that, this.gt(that))
    }

    pub fn gt_scalar(self, other: Number) -> TCResult<ArrayAccess<u8>> {
        block_dispatch!(
            self,
            this,
    ...
    pub fn ge(self, other: Self) -> TCResult<ArrayAccess<u8>> {
        block_cmp!(self, other, this, that, this.ge(that))
    }

    pub fn ge_scalar(self, other: Number) -> TCResult<ArrayAccess<u8>> {
        block_dispatch!(
            self,
            this,
    ...
    pub fn lt(self, other: Self) -> TCResult<ArrayAccess<u8>> {
        block_cmp!(self, other, this, that, this.lt(that))
    }

    pub fn lt_scalar(self, other: Number) -> TCResult<ArrayAccess<u8>> {
        block_dispatch!(
            self,
            this,
    ...
    pub fn le(self, other: Self) -> TCResult<ArrayAccess<u8>> {
        block_cmp!(self, other, this, that, this.le(that))
    }

    pub fn le_scalar(self, other: Number) -> TCResult<ArrayAccess<u8>> {
        block_dispatch!(
            self,
            this,
    ...
    pub fn ne(self, other: Self) -> TCResult<ArrayAccess<u8>> {
        block_cmp!(self, other, this, that, this.ne(that))
    }

    pub fn ne_scalar(self, other: Number) -> TCResult<ArrayAccess<u8>> {
        block_dispatch!(
            self,
            this,
...
macro_rules! block_from {
    ($t:ty, $var:ident) => {
        impl From<ArrayAccess<$t>> for Block {
            fn from(array: ArrayAccess<$t>) -> Self {
                Self::$var(array)
            }
        }
    };
